                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control subachiever-dropdown" required name="sub_achiever">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#edit-modal').on('show.bs.modal', function() {
                ...
                var sub_achiever_id = row.children(".subachiever").data('subacheiver-id');
                var image_position = row.children(".image_position").text();
                var file = row.children(".image").text();
                ...
                if (select) {
                    ...
                    select.sub_achiever_id = sub_achiever_id;
        ...
        $('.delete-btn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('delete-template', ': id ') }}'.replace(':id', itemId),
                        type: 'GET',
                        headers: {
